<?php
/*
Plugin Name: Silverlight Audio Player for WordPress
Plugin URI: http://timheuer.com/silverlight-audio-for-wordpress
Description: An audio player plugin for WordPress to host a Silverlight player
Version: 1.0.5
Author: Tim Heuer
...
define("SILVERLIGHT_META_START", "[slaudio:");
define("SILVERLIGHT_META_END", "]");
define("SILVERLIGHT_TARGET", "<div id=\"silverlightAudioControlHost\"><object data=\"data:application/x-silverlight-2,\" type=\"application/x-silverlight-2\" width=\"295\" height=\"30\"><param name=\"source\" value=\"/wp-content/plugins/silverlight-audio-player/AudioPlayer.xap\"/><param name=\"background\" value=\"Transparent\" /><param name=\"windowless\" value=\"true\" /><param name=\"minRuntimeVersion\" value=\"3.0.40818.0\" /><param name=\"autoupgrade\" value=\"true\" /><param name=\"enableHtmlAccess\" value=\"true\" />###PARAMHOLDER###<a href=\"http://go.microsoft.com/fwlink/?LinkID=149156\" style=\"text-decoration: none;\"><img src=\"http://storage.timheuer.com/sl4wp-ph.png\" alt=\"Install Microsoft Silverlight\" style=\"border-style: none; width:400px; height:200px\"/></a></object><iframe style=\"visibility:hidden;height:0;width:0;border:0px\" id=\"_sl_historyFrame\"></iframe></div>");
define("SILVERLIGHT_INITPARAMS", "<param name=\"initParams\" value=\"Url=###URL###,Artist=###ARTIST###,Title=###TITLE###\" />");

function silverlight_audio_the_content($content)
{
	...
	//$output = str_replace("###ARTIST###", $artist, $output);
	//$output = str_replace("###TITLE###", $title, $output);
 	$paramHolder = str_replace("###URL###", $url, $paramHolder);
 	$paramHolder = str_replace("###ARTIST###", $artist, $paramHolder);
 	$paramHolder = str_replace("###TITLE###", $title, $paramHolder); 
...
function silverlight_audio_wp_head()
{
	echo "<style type=\"text/css\">\n<!-- Silverlight Audio Player WordPress Plugin -->\n#silverlightAudioControlHost{height:30px;width:295px}\n</style>";
}

add_action('wp_head', 'silverlight_audio_wp_head');
add_filter('the_content', 'silverlight_audio_the_content');
